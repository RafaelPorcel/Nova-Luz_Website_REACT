    ...
    return (
        <div className="container">
            <div className="row align-items-center">
                <div className="texto ">
                    <h2 className="col-md-10 titulo_nosotros">NOVA-LUZ</h2>
                    <p className="col-md-12 parrafo_nosotros">Somos una empresa dedicada al sector de la
                        electricidad, iluminación, telecomunicaciones y redes. Ofrecemos tanto venta de productos
                        como instalación y reparación.</p>
                    <p className="col-md-12 parrafo_nosotros"> Situados en Pozoblanco, más de 20 años nos avalan en los
                        que
                    ...
                    <p className="col-md-12 parrafo_nosotros">
                    ...
                    <p className="col-md-12 parrafo_nosotros">Trabajamos con los mejores proveedores del país y
                        ofrecemos la
                        máxima calidad. Somos instaladores autorizados por la Junta de Andalucía.</p>
                    <p className="col-md-12 parrafo_nosotros">No dudes en pasarte por nuestra tienda o ponerte en
                        contacto
                        con nosotros.</p>
                </div>
            </div>
